...
1.	Make  sure  the   project   from   the   previous  Jab  is   open   in  your
Solution  Explorer.
...
This  method  is the  central  control  point  for  your  routes  and is
located in the <span style="font-family:Courier New;">~/App Start/RouteConfig.cs </span>file. Because you're starting with attribute routes, you'11 clear out everything in the <span style="font-family:Courier New;">RegisterRoutes</span> method for now and just have it enable attribute routing by calling the  <span style="font-family:Courier New;">MapMvcAttributeRoutes</span>  registration method.
