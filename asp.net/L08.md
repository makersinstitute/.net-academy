...
4. The next step is to implement a Search method on the HorneController. The code block shown in the below makes the simplifying assumption that a user is always searching for music  by album name:
